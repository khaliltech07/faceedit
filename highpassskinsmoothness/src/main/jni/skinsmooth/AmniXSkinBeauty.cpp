...
AmniXSkinBeauty *AmniXSkinBeauty::instance;

AmniXSkinBeauty *AmniXSkinBeauty::getInstance() {
    if (instance == NULL)
        instance = new AmniXSkinBeauty();
    return instance;
}

AmniXSkinBeauty::AmniXSkinBeauty() {
    LOGE("MagicBeauty");
...
void AmniXSkinBeauty::initBeauty(JniBitmap *jniBitmap) {
    LOGE("initBeauty");
...
void AmniXSkinBeauty::unInitBeauty() {
    if (instance != NULL)
        delete instance;
    instance = NULL;
}
...
void AmniXSkinBeauty::startSkinSmooth(float smoothlevel) {
    _startBeauty(smoothlevel, mWhitenLevel);
}

void AmniXSkinBeauty::startWhiteSkin(float whitenlevel) {
    _startBeauty(mSmoothLevel, whitenlevel);
}

void AmniXSkinBeauty::_startBeauty(float smoothlevel, float whitenlevel) {
...
void AmniXSkinBeauty::_startWhiteSkin(float whitenlevel) {
...
void AmniXSkinBeauty::_startSkinSmooth(float smoothlevel) {
...
void AmniXSkinBeauty::initSkinMatrix() {
    LOGE("initSkinMatrix");
    if (mSkinMatrix == NULL)
...
void AmniXSkinBeauty::initIntegral() {
    LOGE("initIntegral");
    if (mIntegralMatrix == NULL)
